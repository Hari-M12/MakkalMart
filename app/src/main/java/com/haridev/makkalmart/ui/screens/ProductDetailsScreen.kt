...
fun ProductDetailsScreen(
    ...
    viewModel: MakkalMartViewModel
) {
    val product = productId?.let { viewModel.getProductById(it) }

    Scaffold(topBar = {
            TopAppBar(title = { Text("Product Details", color = MaterialTheme.colorScheme.onPrimary)
                },
        ...
        if (product == null) {
            ...
            Column(modifier = Modifier.padding(innerPadding).padding(14.dp).verticalScroll(rememberScrollState()),
